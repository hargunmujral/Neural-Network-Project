...
def Single_iter_gradient_descent(input_matrix, output_matrix, weight_matrix, bias_matrix, learning_rate):
    ...
    y_pred = matrix_dot_prod(weight_matrix, input_matrix) + bias_matrix
    ...
    weight_matrix = matrix_dot_prod(weight_matrix, learning_rate) + matrix_dot_prod(loss_derivative, input_matrix)
    bias_matrix = bias_matrix + matrix_dot_prod(loss_derivative, learning_rate)
