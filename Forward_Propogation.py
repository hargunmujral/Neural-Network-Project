...
from Matrix_operations import matrix_multiplication, matrix_addition, matrix_multiplication
...
def forward_propogation(Weight_matrix, Bias_matrix, Input_matrix, activation_function):
    ...
    adjustment = matrix_addition(matrix_multiplication(Weight_matrix, Input_matrix), Bias_matrix)
